...
export const Sidebar = memo(function Sidebar({
  ...
  return (
    <aside id="app-sidebar" className={mobileOpen ? "sidebar is-open" : "sidebar"} aria-label="主导航">
      ...
      <div className="sidebar__brand"><div className="brand-mark"><Sprout size={20} /></div><div><div className="brand-name">云寻</div><div className="brand-subname">农业工作台</div></div></div>
